...
function NavigationBar() {
  ...
  return (
    <>
      <div className="sticky w-full flex flex-row items-center justify-between p-6 px-20 bg-white shadow-sm">
        <div className="tracking-tight text-4xl font-bold">UniStudy</div>
        <div className="flex flex-row items-center justify-evenly space-x-6">
          <div className="w-12 p-3 flex flex-row items-center justify-center hover:border-purple-600 hover:text-purple-600 h-12 rounded-full border border-gray-200">
