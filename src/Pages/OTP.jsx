...
function OTP() {
  ...
  const submitOtp = async (e) => {
    ...
    try {
      const response = await BaseFetch(
        `${BASE_URL}/users/verify_code?code=${otp}`,
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${state?.token}`,
  ...
  return (
    <div className="bg-bgprimary lg:bg-[url('./src/assets/bg2.jpg')] min-h-screen bg-cover flex justify-center items-center">
      <div className="flex-col w-full mx-auto md:w-7/12 lg:w-5/12 xl:w-4/12 p-4 bg-bgprimary rounded-xl  backdrop-blur border border-gray-300">
